...
export function EditorToolbar({ editor, className = '', onLinkParams, onImageClick }: EditorToolbarProps) {
  ...
  return (
    <div className={`flex flex-wrap items-center gap-0.5 px-2 py-2 bg-white/80 backdrop-blur-sm border-b border-gray-200 sticky top-0 z-20 ${className}`}>
      ...
      <ToolbarButton onClick={onImageClick || (() => {})} isActive={editor.isActive('image')} title="Insert Image">
        <Icons.Image />
      </ToolbarButton>
